...
- Data: 2026-04-01 06:58:48 Europe/Warsaw
- URL: https://coapebehawiorysta.vercel.app
- Wynik ogólny: FAIL
- Kroki zaliczone: 14/17
- Liczba zebranych issue z runtime: 0
- Booking QA identity: QA LIVE 20260401-065848 / qa-live-20260401-065848@example.com
...
Call log:
[2m  - waiting for locator('.booking-row').filter({ hasText: 'qa-live-20260401-065848@example.com' }).first().getByRole('button', { name: /Odrzuć wpłatę/i }) to be visible[22m
...
- End URL: https://coapebehawiorysta.vercel.app/form?problem=kot&slotId=2026-04-01-09%3A20
- Note: Wybrany temat: kot
- Note: Wybrany slot: 09:20

### PASS - Booking live: formularz -> payment
- Start URL: https://coapebehawiorysta.vercel.app/form?problem=kot&slotId=2026-04-01-09%3A20
- End URL: https://coapebehawiorysta.vercel.app/payment?bookingId=086b7a1d-41a3-458d-a192-2c6a5832c5ac&access=ZPmh1FYNdkyCGPq5mW6bTEYfWI_hojOI
- Note: manualVisible=true
- Note: payuVisible=true

### PASS - Booking live: pokój zablokowany przed paid
- Start URL: https://coapebehawiorysta.vercel.app/payment?bookingId=086b7a1d-41a3-458d-a192-2c6a5832c5ac&access=ZPmh1FYNdkyCGPq5mW6bTEYfWI_hojOI
- End URL: https://coapebehawiorysta.vercel.app/payment?bookingId=086b7a1d-41a3-458d-a192-2c6a5832c5ac&access=ZPmh1FYNdkyCGPq5mW6bTEYfWI_hojOI
