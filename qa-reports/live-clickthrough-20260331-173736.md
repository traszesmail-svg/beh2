...
- Data: 2026-03-31 17:37:36 Europe/Warsaw
- URL: https://coapebehawiorysta.vercel.app
- Wynik ogólny: FAIL
- Kroki zaliczone: 12/17
- Liczba zebranych issue z runtime: 0
- Booking QA identity: QA LIVE 20260331-173736 / qa-live-20260331-173736@example.com
...
- Header: Koty: page.waitForURL: Timeout 20000ms exceeded.
=========================== logs ===========================
waiting for navigation until "load"
============================================================
- Header: Pobyty: page.waitForURL: Timeout 20000ms exceeded.
=========================== logs ===========================
waiting for navigation until "load"
============================================================
- Booking live: zgłoszenie manual payment -> pending: page.waitForURL: Timeout 20000ms exceeded.
=========================== logs ===========================
waiting for navigation until "load"
============================================================
- Admin live: odrzucenie testowej wpłaty QA: locator.waitFor: Timeout 20000ms exceeded.
Call log:
[2m  - waiting for locator('.booking-row').filter({ hasText: 'qa-live-20260331-173736@example.com' }).first().getByRole('button', { name: /Odrzuć wpłatę/i }) to be visible[22m
...
- Note: page.waitForURL: Timeout 20000ms exceeded.
=========================== logs ===========================
waiting for navigation until "load"
============================================================
...
- End URL: https://coapebehawiorysta.vercel.app/form?problem=kot&slotId=2026-03-31-18%3A00
- Note: Wybrany temat: kot
- Note: Wybrany slot: 18:00

### PASS - Booking live: formularz -> payment
- Start URL: https://coapebehawiorysta.vercel.app/form?problem=kot&slotId=2026-03-31-18%3A00
- End URL: https://coapebehawiorysta.vercel.app/payment?bookingId=4553ea29-cc54-4d18-962b-ad43be552cc3&access=YIFTUgUOmHUZdLt2abl-EHtarbc29fb2
- Note: manualVisible=true
- Note: payuVisible=true

### PASS - Booking live: pokój zablokowany przed paid
- Start URL: https://coapebehawiorysta.vercel.app/payment?bookingId=4553ea29-cc54-4d18-962b-ad43be552cc3&access=YIFTUgUOmHUZdLt2abl-EHtarbc29fb2
- End URL: https://coapebehawiorysta.vercel.app/payment?bookingId=4553ea29-cc54-4d18-962b-ad43be552cc3&access=YIFTUgUOmHUZdLt2abl-EHtarbc29fb2
