...
export const FUNNEL_SERVICE_CONFIG: Record<AnyBookingServiceType, FunnelServiceConfig> = {
  ...
  'konsultacja-behawioralna-online': {
    ...
    durationMinutes: 60,
    durationLabel: 'pelny zakres',
    priceAmount: 470,
    pricePrefix: null,
    mode: 'online',
    slotSpan: 3,
    slotSummary: 'Pelna konsultacja behawioralna: rozmowa online, diagnoza i plan pracy.',
    slotBadge: 'pelny zakres',
    roomSummary: 'Pelna konsultacja behawioralna online: rozmowa, diagnoza i 7 dni konsultacji tekstowych przez WhatsApp.',
    publicSummary:
      'Pelna konsultacja behawioralna online: rozmowa audio lub video, diagnoza, plan poprawy i 7 dni konsultacji tekstowych przez WhatsApp.',
