...
export const FUNNEL_SERVICE_CONFIG: Record<AnyBookingServiceType, FunnelServiceConfig> = {
  ...
  'konsultacja-behawioralna-online': {
    ...
    durationMinutes: 120,
    durationLabel: 'ok. 2 h',
    priceAmount: 350,
    pricePrefix: null,
    mode: 'online',
    slotSpan: 6,
    slotSummary: 'Pelna konsultacja behawioralna: ok. 2 h rozmowy online.',
    slotBadge: 'ok. 2 h',
    roomSummary: 'Pelna konsultacja behawioralna online, ok. 2 h lacznie.',
    publicSummary:
      'Pelna konsultacja behawioralna online, ok. 2 h lacznie. Zawiera wstepny Kwadrans z behawiorysta dla rozpoznania problematyki i wstepnych zalecen.',
