...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    whenToChoose: 'Gdy liczy sie szybki kontakt dzisiaj, standardowy terminarz nie pasuje albo chcesz wejsc w rozmowe w ciagu 15 minut.',
    ...
    cardSummary: 'Ten sam Kwadrans, ale z priorytetem.',
    ...
    outcomes: ['prosba o termin trafia od razu do panelu admina', 'od razu wiadomo, czy da sie wejsc w rozmowe w ciagu 15 minut', 'klient dostaje gotowy link do rezerwacji'],
