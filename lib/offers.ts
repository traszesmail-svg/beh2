...
export const OFFERS: Offer[] = [
  {
    ...
    nextStep: 'Wybierasz temat, termin i platnosc. Po rozmowie dostajesz diagnoze sytuacji i przewodnik PDF z podstawami dla psa lub kota.',
    cardSummary: 'Diagnoza, plan na start i PDF z podstawami dla Twojego zwierzecia.',
    heroSummary: '15 minut rozmowy audio bez kamery. Po rozmowie dostajesz diagnoze sytuacji i przewodnik PDF z podstawami dla psa lub kota.',
    descriptions: [
      'To dobry wybor, gdy temat jest swiezy, waski albo nie wiesz jeszcze, jak duzy jest problem.',
      'Po rozmowie dostajesz diagnoze sytuacji, pierwsze zalecenia i przewodnik PDF (~20 stron) z podstawami dla psa lub kota dopasowany do Twojej sytuacji.',
    ],
    bestFor: ['jedno pytanie', 'orientacja w temacie', 'spokojny pierwszy krok z diagnoza'],
    outcomes: ['diagnoza sytuacji i priorytetow', 'co zrobic od razu', 'przewodnik PDF z podstawami dla psa lub kota'],
    ...
    note: 'W cenie Kwadransu: diagnoza sytuacji i przewodnik PDF (~20 stron) z podstawami dla psa lub kota. Jesli temat okaze sie szerszy, wskazemy kolejny krok.',
  },
  {
