...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    nextStep: 'Rezerwujesz dluzszy termin online zamiast zaczynac od krotszego formatu.',
    cardSummary: 'Najpelniejszy start dla trudniejszej sprawy.',
    heroSummary: 'Pelna rozmowa online, ok. 2 h lacznie, gdy temat wymaga szerszej analizy juz na wejsciu.',
    descriptions: [
      'To format dla sytuacji, w ktorych szybki start bylby zbyt plytki: problem wraca, narasta albo dotyka kilku rzeczy naraz.',
      'Pelna konsultacja zawiera wstepny Kwadrans z behawiorysta dla rozpoznania problematyki i wstepnych zalecen.',
    ],
    bestFor: ['temat zlozony', 'kilka problemow naraz', 'gdy potrzebujesz ok. 2 h lacznie'],
    ...
    imageWidth: SPECIALIST_ONLINE_PHOTO.width,
    imageHeight: SPECIALIST_ONLINE_PHOTO.height,
    note: 'Pelna konsultacja trwa ok. 2 h lacznie i zawiera wstepny Kwadrans z behawiorysta dla rozpoznania problematyki i wstepnych zalecen.',
  },
  {
    slug: 'poradniki-pdf',
