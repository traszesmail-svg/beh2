...
export const OFFERS: Offer[] = [
  {
    ...
    descriptions: [
      ...
      'Po rozmowie wiesz, czy wystarczy ten pierwszy krok, czy lepiej przejść do Dwóch kwadransów albo Pełnej konsultacji.',
    ],
    bestFor: ['jedno pytanie', 'orientacja w temacie', 'spokojny pierwszy krok'],
    outcomes: ['ustalenie priorytetu', 'co zrobić od razu', 'jasna decyzja o kolejnym kroku'],
    ...
    note: 'Kwadrans to 15 minut audio bez kamery. Służy do nazwania problemu i wybrania dalszego kierunku.',
  },
  {
    ...
    heroSummary: '15 minut audio bez kamery z priorytetem i możliwie szybkim terminem.',
    descriptions: [
    ...
    outcomes: ['pierwszy kierunek bez czekania na zwykły termin', 'ten sam format 15 minut co w Kwadransie', 'jasna decyzja, czy potrzebny jest kolejny krok'],
    ...
    imageWidth: SPECIALIST_WIDE_PHOTO.width,
    imageHeight: SPECIALIST_WIDE_PHOTO.height,
    note: 'To ten sam format 15 minut co Kwadrans za 69 zł. Różnica dotyczy tylko tempa potwierdzenia terminu.',
  },
  {
