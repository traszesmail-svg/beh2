...
export const OFFERS: Offer[] = [
  {
    ...
    cardSummary: '15 minut audio bez kamery. Diagnoza behawioralna oparta na informacjach przekazanych przez opiekuna i ustalenie priorytetu.',
    heroSummary: '15 minut rozmowy audio bez kamery. Diagnoza behawioralna oparta na informacjach przekazanych przez opiekuna i pierwszy dalszy kierunek.',
    descriptions: [
    ...
    note: 'Kwadrans to 15 minut audio bez kamery. Służy do stworzenia diagnozy behawioralnej opartej na informacjach przekazanych przez opiekuna i wybrania dalszego kierunku.',
  },
  {
    ...
    cardSummary: 'Ten sam zakres co Kwadrans: diagnoza behawioralna oparta na informacjach i szybszy termin.',
    heroSummary: '15 minut audio bez kamery z diagnozą behawioralną opartą na informacjach i priorytetem terminu.',
    descriptions: [
    ...
    imageWidth: SPECIALIST_WIDE_PHOTO.width,
    imageHeight: SPECIALIST_WIDE_PHOTO.height,
    note: 'To ten sam format 15 minut co Kwadrans za 69 zł: diagnoza behawioralna oparta na informacjach przekazanych przez opiekuna. Różnica dotyczy tylko tempa potwierdzenia terminu.',
  },
  {
  ...
  },
  {
    ...
    nextStep: 'Umawiasz pełną konsultację online. Po rozmowie dostajesz diagnozę behawioralną opartą na danych, prawdopodobną etiologię, możliwy przebieg sytuacji, aktualizowany plan pracy i zalecenia dzienne pod nadzorem behawiorysty przez 7 dni.',
    cardSummary: 'Diagnoza behawioralna oparta na danych, prawdopodobna etiologia, plan pracy i 7 dni codziennych zaleceń pod nadzorem.',
    heroSummary: 'Rozmowa online z diagnozą behawioralną opartą na danych, prawdopodobną etiologią, indywidualnym planem i 7 dniami codziennych zaleceń pod nadzorem behawiorysty (8h dziennie przez WhatsApp).',
    descriptions: [
      'To format dla sytuacji, w których szybki start byłby zbyt płytki: problem wraca, narasta albo dotyka kilku rzeczy naraz.',
      'Po rozmowie dostajesz diagnozę behawioralną opartą na danych, prawdopodobną etiologię, możliwy przebieg sytuacji, indywidualny plan pracy i codzienne zalecenia przez 7 dni pod nadzorem behawiorysty dostępnego na WhatsApp 8h dziennie.',
    ],
    ...
    outcomes: ['diagnoza behawioralna oparta na danych, prawdopodobna etiologia i priorytety', 'aktualizowany plan pracy krok po kroku', '7 dni codziennych zaleceń - behawiorysta dostępny 8h dziennie przez WhatsApp'],
