...
export const PUBLIC_OFFER_DECISION_COPY = {
  ...
  urgent:
    'Kwadrans na już to ten sam 15-minutowy format audio co Kwadrans za 69 zł — r??nica polega tylko na szybszym potwierdzeniu terminu (do 15 minut od wpłaty). To nie jest dłuższa konsultacja.',
  bridge:
...
export const PUBLIC_OFFER_BOOKING_REASSURANCE =
  'Nie musisz miec gotowej diagnozy. Wystarczy krótki opis sytuacji i propozycja terminów. Po wysłaniu formularza potwierdzam, który format i termin mają w Twojej sytuacji najwięcej sensu.'
...
export const PUBLIC_OFFER_FULL_CONSULTATION_VALUE =
  'Pełna konsultacja nie jest dłuższa wersja Kwadransu. To osobny format dla spraw, które wymagaja więcej czasu, szerszego tla i wsparcia po rozmowie. Obejmuje konsultacje online, diagnozę sytuacji, aktualizowany plan pracy i 7 dni codziennych zaleceń pod nadzorem behawiorysty dostępnego 8h dziennie przez WhatsApp.'

export const PUBLIC_OFFER_CANCELLATION_COPY =
  'Krótkie formaty mają 24 godziny na bezpłatna rezygnacje po potwierdzeniu wpłaty. Zmiane terminu ustalamy w tym samym oknie. Pełna konsultacja ma osobny regulamin.'
...
export const PUBLIC_OFFER_FULL_VALUE_POINTS = [
  ...
  '7 dni codziennych zaleceń — behawiorysta dostępny 8h/dzien przez WhatsApp',
] as const
