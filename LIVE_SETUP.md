...
- admin ma osobna akcje `PotwierdŸ QA` dla takich bookingow
...
Raporty i rytual:
- `npm run funnel-metrics` zapisuje `qa-reports/latest-funnel-metrics.md` i archiwum z timestampem; raport czyta lokalny JSON fallback ledgeru, wiêc dzia³a nawet wtedy, gdy Supabase nie jest dostêpny w tej maszynie
