// handoff-4/components/LoadingSpinner.tsx
// Spinner dla loading states — formularze, rezerwacje, fetch'e
// Brand-aligned (zielony accent) + accessible
...
// Skeleton loader dla list opinii / kart oferty
