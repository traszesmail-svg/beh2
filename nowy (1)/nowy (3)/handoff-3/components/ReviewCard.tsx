// handoff-3/components/ReviewCard.tsx
// Pojedyncza karta opinii — używana w karuzeli i grid
  ...
  return (
    ...
    >
      ...
      <footer className="flex items-center gap-3 pt-4 border-t border-neutral-100">
        ...
        <div>
          <div className="font-semibold text-ink text-sm">{review.author}</div>
