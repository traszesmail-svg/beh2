...
const offers: Offer[] = [
  {
    ...
    title: 'Kwadrans',
    price: '69 zł',
    desc: 'Podstawowa usługa: 15 minut audio bez kamery, żeby nazwać problem i ustalić pierwszy kierunek.',
    features: ['podstawowy start', '15 min audio', '69 zł'],
    highlight: true,
    bookUrl: '/book',
  },
  {
    ...
    price: '99 zł',
    desc: 'Ten sam zakres co Kwadrans 69 zł, tylko dla pilniejszego terminu.',
  ...
  },
  {
    ...
    features: ['Pełny zakres online', 'Plan poprawy', '7 dni WhatsApp'],
