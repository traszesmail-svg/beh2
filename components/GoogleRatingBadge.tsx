...
export function GoogleRatingBadge({
  ...
  if (variant === 'compact') {
    return (
      ...
      >
        <GoogleLogo size={14} />
        <span className="font-bold" style={{ color: 'var(--ink, #1c1a18)' }}>{ratingValue.toFixed(1)}</span>
    ...
    >
      ...
      <div>
        <div className="flex items-center gap-1 mb-0.5">
          ...
          <span className="ml-2 font-bold" style={{ color: 'var(--ink, #1c1a18)' }}>{ratingValue.toFixed(1)}</span>
        </div>
