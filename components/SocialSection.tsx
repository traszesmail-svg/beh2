    ...
    <section className="panel section-panel social-section" aria-labelledby="social-heading">
      <div className="section-head">
        <div>
          ...
          <h2 id="social-heading">
            Sprawdź profil i podeślij stronę osobie, która też potrzebuje spokojnego wsparcia
          </h2>
        </div>
        <div className="muted">
          Pokazujemy tylko kanały, które są gotowe do publicznego ruchu. Kolejne profile dołączymy dopiero po uruchomieniu oficjalnych kont.
        </div>
      </div>
      ...
      <div className="social-grid top-gap">
        ...
        <div className="social-card">
          ...
          <span>Link dodamy dopiero wtedy, gdy oficjalne konto będzie gotowe do publicznego ruchu.</span>
        </div>
        ...
        <div className="social-card">
          <span className="social-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" className="social-svg">
              <path
                d="M14.8 5.7c.7.6 1.2 1 2.1 1.2v2.5c-1.2-.1-2.2-.5-3.2-1.2v4.6c0 2.5-1.8 4.4-4.4 4.4A4.4 4.4 0 0 1 7.8 8.7v2.8a1.9 1.9 0 1 0 2 1.9V4.8h2.7c0 .4.1.7.3.9.3.1.6.4 2 .9Z"
                fill="currentColor"
              />
            </svg>
          </span>
          <strong>TikTok</strong>
          <span>Miejsce pod przyszły kanał edukacyjny. Link pojawi się dopiero po przygotowaniu profilu.</span>
        </div>
      </div>
    </section>
  )
